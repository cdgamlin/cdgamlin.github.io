...
* Channel information is parsed across multiple fields to obtain useful information, eg: the country a channel is from
...
* "DOMN" 4 letter codes are based on the server name (eg: all pluto.tv channels are "PLTO")
...
* Channels are grouped into category (where possible) or into subcontinent the channel comes from
